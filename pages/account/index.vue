<template>
          ...
          <div class="w-full px-4">
            ...
            >
              ...
              <div class="mb-8 flex items-center justify-center">
                <span
                  class="hidden h-[1px] w-full max-w-[70px] bg-body-color/50 sm:block"
                ></span>
                <p
              ...
              <form>
                ...
                <div
                  class="mb-8 flex flex-col justify-between sm:flex-row sm:items-center"
                >
                  <div class="mb-4 sm:mb-0">
                    <label
                      htmlFor="checkboxLabel"
                      class="flex cursor-pointer select-none items-center text-sm font-medium text-body-color"
                    >
                      <div class="relative">
                        <input
                          type="checkbox"
                        ...
                        />
                        <div
                          class="box mr-4 flex h-5 w-5 items-center justify-center rounded border border-body-color border-opacity-20 dark:border-white dark:border-opacity-10"
                        >
              ...
              <p class="text-center text-base font-medium text-body-color">
                ...
                <a class="text-primary hover:underline"> Sign up </a>
              </p>
            </div>
          </div>
        </div>
  ...
  >
    <mask
      ...
      height="969"
    >
      <rect width="1440" height="969" fill="#1E293B" />
    </mask>
    ...
    <defs>
      ...
      >
        <stop stop-color="#2D3B4C" />
        <stop offset="1" stop-color="#2D3B4C" stop-opacity="0" />
      </linearGradient>
      <linearGradient
