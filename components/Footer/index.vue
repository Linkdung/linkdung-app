...
<template>
  <footer
    class="wow fadeInUp dark:bg-gray-dark relative z-10 bg-white pt-16 md:pt-20 lg:pt-24"
    data-wow-delay=".1s"
  >
    <div class="container">
          ...
          <div class="mb-12 max-w-[360px] lg:mb-16">
            <NuxtLink :to="{ name: 'login' }" class="mb-8 inline-block">
              <div class="flex items-end">
                ...
                />
                <h1 class="ml-2 font-bold text-5xl font-sans">DEV</h1>
              </div>
            </NuxtLink>
            <p
              class="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color"
            >
            ...
            <div class="flex items-center">
              <a
                ...
                class="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary dark:hover:text-primary"
              >
                <svg
                  width="9"
                  height="18"
              ...
              <a
                href="/"
                aria-label="social-link"
                class="dark:text-body-color-dark text-body-color duration-300 hover:text-primary dark:hover:text-primary"
              >
                <svg
                  width="17"
                  height="16"
          ...
          <div class="mb-12 lg:mb-16">
            ...
            <ul>
              <li>
                <a
                  href="/dashboard"
                  class="dark:text-body-color-dark mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                >
                  Dashborad
                </a>
              </li>
      ...
      <div
        class="h-px w-full bg-gradient-to-r from-transparent via-[#D2D8E183] to-transparent dark:via-[#959CB183]"
      ></div>
      <div class="py-8">
    ...
    <div class="absolute right-0 top-14 z-[-1]">
      ...
      >
        ...
        <mask
          ...
          height="99"
        >
          <circle opacity="0.8" cx="49.5" cy="49.5" r="49.5" fill="#663399" />
        </mask>
      ...
      >
        ...
        <defs>
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stop-color="#663399" stop-opacity="0.62" />
            <stop offset="1" stop-color="#663399" stop-opacity="0" />
          </linearGradient>
          <linearGradient
          ...
          >
            ...
            <stop offset="1" stop-color="#663399" stop-opacity="0.51" />
          </linearGradient>
          <linearGradient
